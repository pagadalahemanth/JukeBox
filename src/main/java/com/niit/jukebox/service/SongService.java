...
//        }
    ...
    public void displaySongs() throws SQLException, Exception {
        ArrayList<Songs> songsArrayList;
    ...
    public boolean addSongs(Songs songs, ArrayList<Songs> songsArrayList) throws Exception,SQLException {
        if (songs==null || songsArrayList.isEmpty()) {
            throw new Exception("provide all values");
        } else {
            boolean result = false;
    ...
    public ArrayList<Songs> getSongsByGenre(String genre, ArrayList<Songs> songList) throws Exception {
        if(genre==null || songList.isEmpty()){
            throw new Exception("provide all values");
        }
        else {
